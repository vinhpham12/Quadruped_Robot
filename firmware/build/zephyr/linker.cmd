...
MEMORY
    ...
    RAM (wx) : ORIGIN = 0x20010000, LENGTH = (192 * 1K)
    QSPI_PLACEHOLDER : ORIGIN = 2415919104, LENGTH = 268435456 SRAM0 : ORIGIN = 536936448, LENGTH = 196608 DTCM : ORIGIN = 536870912, LENGTH = 65536 ITCM : ORIGIN = 0, LENGTH = 16384
 ...
 *(".kernel_noinit.*")
    ...
    __kernel_ram_end = 0x20010000 + (192 * 1K);
